import accounting.AccountingProcesses;
import company.RepCorp;
import company.RepairService;
import custom_linked_list.CustomLinkedList;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Normal data
            System.out.println("The sum of invoice -> " + AccountingProcesses.sumOfInvoice("invoice.txt"));
            // Illegal format
//            System.out.println("The sum of invoice -> " + AccountingProcesses.sumOfInvoice("test format.txtt"));
            // wrong data
//            System.out.println("The sum of invoice -> " + AccountingProcesses.sumOfInvoice("wrongData.txt"));
